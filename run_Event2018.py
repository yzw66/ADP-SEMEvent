...
def run_hier_2D_SE_mini_Event2012_open_set(n = 400, e_a = True, e_s = True, test_with_one_block = True, epsilon = 0.2):
    ...
    if test_with_one_block:
        ...
        blocks = [i+1 for i in range(20) if i+1>=2]
    for block in blocks:
        print('\n\n====================================================')
        print('block: ', block)
        ...
        print('ami: ', ami)
        print('ari: ', ari)
        with open("Event2012_test_"+f'{epsilon}.txt', 'a') as f:
...
if __name__ == "__main__":
    ...
    epsilons = [10, 15]
    processes = [create_process_Event2018_open_set(epsilon) for epsilon in epsilons]
